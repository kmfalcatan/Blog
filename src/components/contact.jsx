...
import Message from "../assets/img/chatbox.svg"
import AOS from "aos";
    ...
    <div ref={sectionRef} className="subContactContainer" data-aos="fade">
      ...
      <div className="contact">
        <div className={`subContact ${darkMode ? "dark" : "light"}`} data-aos="fade"  data-aos-delay="300">
          <div className="socialIconContainer">
            <div className={`subSocialIconContainer ${darkMode ? "dark" : "light"}`}>
              <img className={`social ${darkMode ? "dark" : "light"}`} src={Insta} alt="" />
            </div>
          </div>
          ...
          <div className="messageButtonContainer">
            <a href="https://www.linkedin.com/in/khriz-marr-falcatan-846a74179/" target="_blank">
              <button className={`messageButton ${darkMode ? "dark" : "light"}`}>Start chat <img className={`arrow ${darkMode ? "dark" : "light"}`} src={Arrow} alt="" /></button>
            </a>
          </div>
        </div>
        ...
        <div className={`subContact ${darkMode ? "dark" : "light"}`} data-aos="fade"  data-aos-delay="500">
          <div className="socialIconContainer">
            <div className={`subSocialIconContainer ${darkMode ? "dark" : "light"}`}>
              <img className={`social ${darkMode ? "dark" : "light"}`} src={Email} alt="" />
            </div>
          </div>
        ...
        <div className={`subContact ${darkMode ? "dark" : "light"}`} data-aos="fade"  data-aos-delay="700">
          <div className="socialIconContainer">
            <div className={`subSocialIconContainer ${darkMode ? "dark" : "light"}`}>
              <img className={`social ${darkMode ? "dark" : "light"}`} src={Message} alt="" />
            </div>
          </div>
